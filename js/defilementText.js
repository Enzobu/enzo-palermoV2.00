const text = "Je suis étudiant en quatrième année à l'EPSI Montpellier en spécialité développeur. Je suis développeur backend chez CA-TS. Si vous voulez en savoir d'avantage, regardez en dessous ! :)";
